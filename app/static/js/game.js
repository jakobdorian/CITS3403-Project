...
function nextGame(){
    ...
    ids= idGen()
    displayReset()
    setTimeout(function(){beginGame(ids);},1000)
...
function endlessGame(){
    counter1 = 0
    counter2 = 0
    document.getElementById('button03').hidden=true
...
function resultsReset(){
    document.getElementById('res01a').textContent =' Play Game to Obtain Score'
    document.getElementById('res02a').textContent =' Play Game to Obtain Score'
    document.getElementById('res03a').textContent =' Play Game to Obtain Score'
    
    document.getElementById('res01a').style.fontStyle ='italic'
    document.getElementById('res02a').style.fontStyle ='italic'
    document.getElementById('res03a').style.fontStyle ='italic'

    document.getElementById('res01b').textContent =''
    document.getElementById('res02b').textContent =''
    document.getElementById('res03b').textContent =''

    const x = document.getElementById('summary')
    while (x.firstChild){
